    ...
    public var body: some View {
        VStack {
            ...
            Text(message)
                ...
                .padding(.horizontal, configuration.horizontalPadding)
                .padding(.bottom, configuration.bottomMargin)
        }
...
public extension View {
    func toast(
        message: String,
        isPresented: Binding<Bool>,
        configuration: ToastView.ToastConfiguration = ToastView.ToastConfiguration()
    ) -> some View {
        ZStack {
            self
            ToastView(message: message, isPresented: isPresented, configuration: configuration)
        }
    }
} 
